...
public class RuntimeEval
{
	...
	//	static int result = -1;
	//
	//	public static void runBuilder(AlgorithmWrapper alg, DatasetFile dataset) throws Exception
	//	{
	...
	//			featureComputer = new DefaultFeatureComputer(new SmartsMinePropertiesCreator(minFrequency).getSet(dataset));
	//		}
	//		featureComputer.computeFeatures(dataset);
